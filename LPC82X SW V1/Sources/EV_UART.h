...
typedef enum {
	...
	kEvUartCommandGetCPPositive = 13,
	kEvUartCommandGetCPNegative = 14,
	kEvUartCommandGetADCValueCS = 15,
	kEvUartCommandGetIcPWMDutyCycle = 16,
	kEvUartCommandSetIcMax = 17,
	kEvUartCommandSetIDefault = 18,
	kEvUartCommandGetIDefault = 19,
	kEvUartCommandSwitchPWMOn = 20,
	kEvUartCommandSwitchPWMOff = 21,
	kEvUartCommandGetPWMState = 22,
	kEvUartCommandStartCharging = 23,
	kEvUartCommandStopCharging = 24
} EvUartCommand;
